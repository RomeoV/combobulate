...
(ert-deftest combobulate-test-julia-combobulate-drag-down--function-body-1 ()
 "Test `combobulate' with `fixtures/sibling/function-body.jl' in `julia-ts-mode' mode."
	     (combobulate-test
		 (:language julia :mode julia-ts-mode :fixture "fixtures/sibling/function-body.jl")
	       :tags
	       '(combobulate julia julia-ts-mode combobulate-drag-down)
	       (should-error
		(progn
		  (combobulate-test-go-to-marker 1)
		  (combobulate-drag-down)
		  (combobulate-compare-action-with-fixture-delta "./fixture-deltas/combobulate-drag-down/function-body.jl[@1~after].jl")))))


(ert-deftest combobulate-test-julia-combobulate-drag-down--function-body-2 ()
 "Test `combobulate' with `fixtures/sibling/function-body.jl' in `julia-ts-mode' mode."
	     (combobulate-test
		 (:language julia :mode julia-ts-mode :fixture "fixtures/sibling/function-body.jl")
	       :tags
		...
		(progn
		  (combobulate-test-go-to-marker 2)
		  (combobulate-drag-down)
		  (combobulate-compare-action-with-fixture-delta "./fixture-deltas/combobulate-drag-down/function-body.jl[@2~after].jl")))))


(ert-deftest combobulate-test-julia-combobulate-drag-down--function-body-3 ()
 "Test `combobulate' with `fixtures/sibling/function-body.jl' in `julia-ts-mode' mode."
	     (combobulate-test
		 (:language julia :mode julia-ts-mode :fixture "fixtures/sibling/function-body.jl")
	       :tags
		...
		(progn
		  (combobulate-test-go-to-marker 3)
		  (combobulate-drag-down)
		  (combobulate-compare-action-with-fixture-delta "./fixture-deltas/combobulate-drag-down/function-body.jl[@3~after].jl")))))


(ert-deftest combobulate-test-julia-combobulate-drag-down--if-elseif-else-1 ()
 "Test `combobulate' with `fixtures/sibling/if-elseif-else.jl' in `julia-ts-mode' mode."
	     (combobulate-test
		 (:language julia :mode julia-ts-mode :fixture "fixtures/sibling/if-elseif-else.jl")
	       :tags
	       '(combobulate julia julia-ts-mode combobulate-drag-down)
	       (should-error
		(progn
		  (combobulate-test-go-to-marker 1)
		  (combobulate-drag-down)
		  (combobulate-compare-action-with-fixture-delta "./fixture-deltas/combobulate-drag-down/if-elseif-else.jl[@1~after].jl")))))


(ert-deftest combobulate-test-julia-combobulate-drag-down--if-elseif-else-2 ()
 "Test `combobulate' with `fixtures/sibling/if-elseif-else.jl' in `julia-ts-mode' mode."
	     (combobulate-test
		 (:language julia :mode julia-ts-mode :fixture "fixtures/sibling/if-elseif-else.jl")
	       :tags
	       ...
	       (combobulate-test-go-to-marker 2)
	       (combobulate-drag-down)
	       (combobulate-compare-action-with-fixture-delta "./fixture-deltas/combobulate-drag-down/if-elseif-else.jl[@2~after].jl")))


(ert-deftest combobulate-test-julia-combobulate-drag-down--if-elseif-else-3 ()
 "Test `combobulate' with `fixtures/sibling/if-elseif-else.jl' in `julia-ts-mode' mode."
	     (combobulate-test
		 (:language julia :mode julia-ts-mode :fixture "fixtures/sibling/if-elseif-else.jl")
	       :tags
		...
		(progn
		  (combobulate-test-go-to-marker 3)
		  (combobulate-drag-down)
		  (combobulate-compare-action-with-fixture-delta "./fixture-deltas/combobulate-drag-down/if-elseif-else.jl[@3~after].jl")))))
...
(ert-deftest combobulate-test-julia-combobulate-drag-down--struct-fields-1 ()
 "Test `combobulate' with `fixtures/sibling/struct-fields.jl' in `julia-ts-mode' mode."
	     (combobulate-test
		 (:language julia :mode julia-ts-mode :fixture "fixtures/sibling/struct-fields.jl")
	       :tags
	       '(combobulate julia julia-ts-mode combobulate-drag-down)
	       (should-error
		(progn
		  (combobulate-test-go-to-marker 1)
		  (combobulate-drag-down)
		  (combobulate-compare-action-with-fixture-delta "./fixture-deltas/combobulate-drag-down/struct-fields.jl[@1~after].jl")))))


(ert-deftest combobulate-test-julia-combobulate-drag-down--struct-fields-2 ()
 "Test `combobulate' with `fixtures/sibling/struct-fields.jl' in `julia-ts-mode' mode."
	     (combobulate-test
		 (:language julia :mode julia-ts-mode :fixture "fixtures/sibling/struct-fields.jl")
	       :tags
		...
		(progn
		  (combobulate-test-go-to-marker 2)
		  (combobulate-drag-down)
		  (combobulate-compare-action-with-fixture-delta "./fixture-deltas/combobulate-drag-down/struct-fields.jl[@2~after].jl")))))


(ert-deftest combobulate-test-julia-combobulate-drag-down--struct-fields-3 ()
 "Test `combobulate' with `fixtures/sibling/struct-fields.jl' in `julia-ts-mode' mode."
	     (combobulate-test
		 (:language julia :mode julia-ts-mode :fixture "fixtures/sibling/struct-fields.jl")
	       :tags
		...
		(progn
		  (combobulate-test-go-to-marker 3)
		  (combobulate-drag-down)
		  (combobulate-compare-action-with-fixture-delta "./fixture-deltas/combobulate-drag-down/struct-fields.jl[@3~after].jl")))))
...
(ert-deftest combobulate-test-julia-combobulate-drag-down--toplevel-1 ()
 "Test `combobulate' with `fixtures/sibling/toplevel.jl' in `julia-ts-mode' mode."
	     (combobulate-test
		 (:language julia :mode julia-ts-mode :fixture "fixtures/sibling/toplevel.jl")
	       :tags
	       '(combobulate julia julia-ts-mode combobulate-drag-down)
	       (should-error
		(progn
		  (combobulate-test-go-to-marker 1)
		  (combobulate-drag-down)
		  (combobulate-compare-action-with-fixture-delta "./fixture-deltas/combobulate-drag-down/toplevel.jl[@1~after].jl")))))


(ert-deftest combobulate-test-julia-combobulate-drag-down--toplevel-2 ()
 "Test `combobulate' with `fixtures/sibling/toplevel.jl' in `julia-ts-mode' mode."
	     (combobulate-test
		 (:language julia :mode julia-ts-mode :fixture "fixtures/sibling/toplevel.jl")
	       :tags
		...
		(progn
		  (combobulate-test-go-to-marker 2)
		  (combobulate-drag-down)
		  (combobulate-compare-action-with-fixture-delta "./fixture-deltas/combobulate-drag-down/toplevel.jl[@2~after].jl")))))


(ert-deftest combobulate-test-julia-combobulate-drag-down--toplevel-3 ()
 "Test `combobulate' with `fixtures/sibling/toplevel.jl' in `julia-ts-mode' mode."
	     (combobulate-test
		 (:language julia :mode julia-ts-mode :fixture "fixtures/sibling/toplevel.jl")
	       :tags
		...
		(progn
		  (combobulate-test-go-to-marker 3)
		  (combobulate-drag-down)
		  (combobulate-compare-action-with-fixture-delta "./fixture-deltas/combobulate-drag-down/toplevel.jl[@3~after].jl")))))
...
(ert-deftest combobulate-test-julia-combobulate-drag-down--vector-elements-1 ()
 "Test `combobulate' with `fixtures/sibling/vector-elements.jl' in `julia-ts-mode' mode."
	     (combobulate-test
		 (:language julia :mode julia-ts-mode :fixture "fixtures/sibling/vector-elements.jl")
	       :tags
	       '(combobulate julia julia-ts-mode combobulate-drag-down)
	       (should-error
		(progn
		  (combobulate-test-go-to-marker 1)
		  (combobulate-drag-down)
		  (combobulate-compare-action-with-fixture-delta "./fixture-deltas/combobulate-drag-down/vector-elements.jl[@1~after].jl")))))


(ert-deftest combobulate-test-julia-combobulate-drag-down--vector-elements-2 ()
 "Test `combobulate' with `fixtures/sibling/vector-elements.jl' in `julia-ts-mode' mode."
	     (combobulate-test
		 (:language julia :mode julia-ts-mode :fixture "fixtures/sibling/vector-elements.jl")
	       :tags
	       ...
	       (combobulate-test-go-to-marker 2)
	       (combobulate-drag-down)
	       (combobulate-compare-action-with-fixture-delta "./fixture-deltas/combobulate-drag-down/vector-elements.jl[@2~after].jl")))


(ert-deftest combobulate-test-julia-combobulate-drag-down--vector-elements-3 ()
 "Test `combobulate' with `fixtures/sibling/vector-elements.jl' in `julia-ts-mode' mode."
	     (combobulate-test
		 (:language julia :mode julia-ts-mode :fixture "fixtures/sibling/vector-elements.jl")
	       :tags
		...
		(progn
		  (combobulate-test-go-to-marker 3)
		  (combobulate-drag-down)
		  (combobulate-compare-action-with-fixture-delta "./fixture-deltas/combobulate-drag-down/vector-elements.jl[@3~after].jl")))))
