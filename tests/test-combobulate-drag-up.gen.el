...
(ert-deftest combobulate-test-julia-combobulate-drag-up--function-body-3 ()
 "Test `combobulate' with `fixtures/sibling/function-body.jl' in `julia-ts-mode' mode."
		 ...
		 (:language julia :mode julia-ts-mode :fixture "fixtures/sibling/function-body.jl")
	       :tags
	       '(combobulate julia julia-ts-mode combobulate-drag-up)
	       (should-error
		(progn
		  (combobulate-test-go-to-marker 3)
		  (combobulate-drag-up)
		  (combobulate-compare-action-with-fixture-delta "./fixture-deltas/combobulate-drag-up/function-body.jl[@3~after].jl")))))


(ert-deftest combobulate-test-julia-combobulate-drag-up--function-body-2 ()
 "Test `combobulate' with `fixtures/sibling/function-body.jl' in `julia-ts-mode' mode."
	     (combobulate-test
		 (:language julia :mode julia-ts-mode :fixture "fixtures/sibling/function-body.jl")
	       :tags
		...
		(progn
		  (combobulate-test-go-to-marker 2)
		  (combobulate-drag-up)
		  (combobulate-compare-action-with-fixture-delta "./fixture-deltas/combobulate-drag-up/function-body.jl[@2~after].jl")))))


(ert-deftest combobulate-test-julia-combobulate-drag-up--function-body-1 ()
 "Test `combobulate' with `fixtures/sibling/function-body.jl' in `julia-ts-mode' mode."
	     (combobulate-test
		 (:language julia :mode julia-ts-mode :fixture "fixtures/sibling/function-body.jl")
	       :tags
		...
		(progn
		  (combobulate-test-go-to-marker 1)
		  (combobulate-drag-up)
		  (combobulate-compare-action-with-fixture-delta "./fixture-deltas/combobulate-drag-up/function-body.jl[@1~after].jl")))))


(ert-deftest combobulate-test-julia-combobulate-drag-up--if-elseif-else-3 ()
 "Test `combobulate' with `fixtures/sibling/if-elseif-else.jl' in `julia-ts-mode' mode."
		 ...
		 (:language julia :mode julia-ts-mode :fixture "fixtures/sibling/if-elseif-else.jl")
	       ...
	       (combobulate-test-go-to-marker 3)
	       (combobulate-drag-up)
	       (combobulate-compare-action-with-fixture-delta "./fixture-deltas/combobulate-drag-up/if-elseif-else.jl[@3~after].jl")))


(ert-deftest combobulate-test-julia-combobulate-drag-up--if-elseif-else-2 ()
 "Test `combobulate' with `fixtures/sibling/if-elseif-else.jl' in `julia-ts-mode' mode."
	     (combobulate-test
		 (:language julia :mode julia-ts-mode :fixture "fixtures/sibling/if-elseif-else.jl")
	       :tags
		...
		(progn
		  (combobulate-test-go-to-marker 2)
		  (combobulate-drag-up)
		  (combobulate-compare-action-with-fixture-delta "./fixture-deltas/combobulate-drag-up/if-elseif-else.jl[@2~after].jl")))))


(ert-deftest combobulate-test-julia-combobulate-drag-up--if-elseif-else-1 ()
 "Test `combobulate' with `fixtures/sibling/if-elseif-else.jl' in `julia-ts-mode' mode."
	     (combobulate-test
		 (:language julia :mode julia-ts-mode :fixture "fixtures/sibling/if-elseif-else.jl")
	       :tags
		...
		(progn
		  (combobulate-test-go-to-marker 1)
		  (combobulate-drag-up)
		  (combobulate-compare-action-with-fixture-delta "./fixture-deltas/combobulate-drag-up/if-elseif-else.jl[@1~after].jl")))))
...
(ert-deftest combobulate-test-julia-combobulate-drag-up--struct-fields-3 ()
 "Test `combobulate' with `fixtures/sibling/struct-fields.jl' in `julia-ts-mode' mode."
		...
		(progn
		  (combobulate-test-go-to-marker 3)
		  (combobulate-drag-up)
		  (combobulate-compare-action-with-fixture-delta "./fixture-deltas/combobulate-drag-up/struct-fields.jl[@3~after].jl")))))


(ert-deftest combobulate-test-julia-combobulate-drag-up--struct-fields-2 ()
 "Test `combobulate' with `fixtures/sibling/struct-fields.jl' in `julia-ts-mode' mode."
	     (combobulate-test
		 (:language julia :mode julia-ts-mode :fixture "fixtures/sibling/struct-fields.jl")
	       :tags
		...
		(progn
		  (combobulate-test-go-to-marker 2)
		  (combobulate-drag-up)
		  (combobulate-compare-action-with-fixture-delta "./fixture-deltas/combobulate-drag-up/struct-fields.jl[@2~after].jl")))))


(ert-deftest combobulate-test-julia-combobulate-drag-up--struct-fields-1 ()
 "Test `combobulate' with `fixtures/sibling/struct-fields.jl' in `julia-ts-mode' mode."
	     (combobulate-test
		 (:language julia :mode julia-ts-mode :fixture "fixtures/sibling/struct-fields.jl")
	       :tags
		...
		(progn
		  (combobulate-test-go-to-marker 1)
		  (combobulate-drag-up)
		  (combobulate-compare-action-with-fixture-delta "./fixture-deltas/combobulate-drag-up/struct-fields.jl[@1~after].jl")))))
...
(ert-deftest combobulate-test-julia-combobulate-drag-up--toplevel-3 ()
 "Test `combobulate' with `fixtures/sibling/toplevel.jl' in `julia-ts-mode' mode."
		...
		(progn
		  (combobulate-test-go-to-marker 3)
		  (combobulate-drag-up)
		  (combobulate-compare-action-with-fixture-delta "./fixture-deltas/combobulate-drag-up/toplevel.jl[@3~after].jl")))))


(ert-deftest combobulate-test-julia-combobulate-drag-up--toplevel-2 ()
 "Test `combobulate' with `fixtures/sibling/toplevel.jl' in `julia-ts-mode' mode."
	     (combobulate-test
		 (:language julia :mode julia-ts-mode :fixture "fixtures/sibling/toplevel.jl")
	       :tags
		...
		(progn
		  (combobulate-test-go-to-marker 2)
		  (combobulate-drag-up)
		  (combobulate-compare-action-with-fixture-delta "./fixture-deltas/combobulate-drag-up/toplevel.jl[@2~after].jl")))))


(ert-deftest combobulate-test-julia-combobulate-drag-up--toplevel-1 ()
 "Test `combobulate' with `fixtures/sibling/toplevel.jl' in `julia-ts-mode' mode."
	     (combobulate-test
		 (:language julia :mode julia-ts-mode :fixture "fixtures/sibling/toplevel.jl")
	       :tags
		...
		(progn
		  (combobulate-test-go-to-marker 1)
		  (combobulate-drag-up)
		  (combobulate-compare-action-with-fixture-delta "./fixture-deltas/combobulate-drag-up/toplevel.jl[@1~after].jl")))))
...
(ert-deftest combobulate-test-julia-combobulate-drag-up--vector-elements-3 ()
 "Test `combobulate' with `fixtures/sibling/vector-elements.jl' in `julia-ts-mode' mode."
		 ...
		 (:language julia :mode julia-ts-mode :fixture "fixtures/sibling/vector-elements.jl")
	       ...
	       (combobulate-test-go-to-marker 3)
	       (combobulate-drag-up)
	       (combobulate-compare-action-with-fixture-delta "./fixture-deltas/combobulate-drag-up/vector-elements.jl[@3~after].jl")))


(ert-deftest combobulate-test-julia-combobulate-drag-up--vector-elements-2 ()
 "Test `combobulate' with `fixtures/sibling/vector-elements.jl' in `julia-ts-mode' mode."
	     (combobulate-test
		 (:language julia :mode julia-ts-mode :fixture "fixtures/sibling/vector-elements.jl")
	       :tags
	       ...
	       (combobulate-test-go-to-marker 2)
	       (combobulate-drag-up)
	       (combobulate-compare-action-with-fixture-delta "./fixture-deltas/combobulate-drag-up/vector-elements.jl[@2~after].jl")))


(ert-deftest combobulate-test-julia-combobulate-drag-up--vector-elements-1 ()
 "Test `combobulate' with `fixtures/sibling/vector-elements.jl' in `julia-ts-mode' mode."
	     (combobulate-test
		 (:language julia :mode julia-ts-mode :fixture "fixtures/sibling/vector-elements.jl")
	       :tags
		...
		(progn
		  (combobulate-test-go-to-marker 1)
		  (combobulate-drag-up)
		  (combobulate-compare-action-with-fixture-delta "./fixture-deltas/combobulate-drag-up/vector-elements.jl[@1~after].jl")))))
