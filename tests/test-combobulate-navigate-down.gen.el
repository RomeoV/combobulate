...
(ert-deftest combobulate-test-julia-combobulate-navigate-down--function-def-3 ()
 "Test `combobulate' with `fixtures/down/function-def.jl' in `julia-ts-mode' mode."
	     (combobulate-test
		 (:language julia :mode julia-ts-mode :fixture "fixtures/down/function-def.jl")
	       :tags
	       '(combobulate julia julia-ts-mode combobulate-navigate-down)
	       (should-error
		(progn
		  (combobulate-navigate-down)))
	       (should-error
...
(ert-deftest combobulate-test-julia-combobulate-navigate-down--module-2 ()
 "Test `combobulate' with `fixtures/down/module.jl' in `julia-ts-mode' mode."
	     (combobulate-test
		 (:language julia :mode julia-ts-mode :fixture "fixtures/down/module.jl")
	       :tags
	       '(combobulate julia julia-ts-mode combobulate-navigate-down)
	       (should-error
		(progn
