...
(ert-deftest combobulate-test-julia-combobulate-navigate-next--function-body-3 ()
 "Test `combobulate' with `fixtures/sibling/function-body.jl' in `julia-ts-mode' mode."
		 ...
		 (:language julia :mode julia-ts-mode :fixture "fixtures/sibling/function-body.jl")
	       :tags
	       '(combobulate julia julia-ts-mode combobulate-navigate-next)
	       (should-error
		(progn
		  (combobulate-navigate-next)))
	       (should-error
...
(ert-deftest combobulate-test-julia-combobulate-navigate-next--if-elseif-else-3 ()
...
(ert-deftest combobulate-test-julia-combobulate-navigate-next--struct-fields-3 ()
...
(ert-deftest combobulate-test-julia-combobulate-navigate-next--toplevel-3 ()
...
(ert-deftest combobulate-test-julia-combobulate-navigate-next--vector-elements-3 ()
