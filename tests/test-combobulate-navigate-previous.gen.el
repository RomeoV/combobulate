...
(ert-deftest combobulate-test-julia-combobulate-navigate-previous--function-body-1 ()
 "Test `combobulate' with `fixtures/sibling/function-body.jl' in `julia-ts-mode' mode."
		 ...
		 (:language julia :mode julia-ts-mode :fixture "fixtures/sibling/function-body.jl")
	       :tags
	       '(combobulate julia julia-ts-mode combobulate-navigate-previous)
	       (should-error
		(progn
		  (combobulate-navigate-previous)))
	       (combobulate-test-go-to-marker 1)
...
(ert-deftest combobulate-test-julia-combobulate-navigate-previous--if-elseif-else-1 ()
...
(ert-deftest combobulate-test-julia-combobulate-navigate-previous--struct-fields-1 ()
...
(ert-deftest combobulate-test-julia-combobulate-navigate-previous--toplevel-1 ()
...
(ert-deftest combobulate-test-julia-combobulate-navigate-previous--vector-elements-1 ()
